const Qoute = () => {
  return (
    <section className="relative overflow-hidden bg-[#161C28] px-6 py-12 sm:px-8 md:px-12 lg:px-16 xl:px-20 md:py-20">
      {/* Horizontal gradient */}
      <div
        aria-hidden="true"
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <p className="text-white font-light text-sm sm:text-base leading-7 sm:leading-8 text-center md:text-left">
          ...
          knowledge, tools and strategic frameworks to adopt AI responsibly and
          profitably.
        </p>
      </div>
    </section>
