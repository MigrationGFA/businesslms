    ...
    <section className="relative overflow-hidden bg-[#161C28] px-6 py-20 sm:px-8 md:px-12 lg:px-16 xl:px-20 md:py-40">
      ...
      <div className="relative">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <h1 className="mb-6 text-white md:font-normal font-bold text-center md:text-left leading-relaxed text-xl md:text-3xl lg:text-4xl">
            AI is no longer a future trend, it is reshaping how businesses
            operate, compete and grow.
          </h1>

          <p className="text-white font-light text-sm md:text-base leading-7 sm:leading-8 text-center md:text-left">
