                    ...
                    >
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onFocus={() =>
                            trackFieldFocus("modal", "companyEmail")
                          }
                          onBlur={() =>
                            trackFieldFilled(
                              "modal",
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onFocus={() =>
                            trackFieldFocus("modal", "phoneNumber")
                          }
                          onBlur={() =>
                            trackFieldFilled(
                              "modal",
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onFocus={() =>
                            trackFieldFocus("modal", "companyName")
                          }
                          onBlur={() =>
                            trackFieldFilled(
                              "modal",
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onFocus={() =>
                            trackFieldFocus("modal", "hearAboutUs")
                          }
                          onBlur={() =>
                            trackFieldFilled(
                              "modal",
                        ...
                        {formData.hearAboutUs === "Other" && (
                          <div className="mt-3">
                            ...
                            <input
                              ...
                              onFocus={() =>
                                trackFieldFocus("modal", "hearAboutUsOther")
                              }
                              onBlur={() =>
                                trackFieldFilled(
                                  "modal",
                    ...
                    {/* <div className="flex flex-col gap-3">
                      {status === "success" && (
                        <motion.a
                          ...
                          href={BOOKING_URL}
                          onClick={() =>
                            trackEvent("book_strategy_session_clicked", {
                              source: "modal",
                            })
                          }
                          target="_blank"
